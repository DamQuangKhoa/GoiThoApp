...
public class BlogStackAdapter extends PagerAdapter {
    Context context;
    ...
    public BlogStackAdapter(Context applicationContext, List<PostEntity> list, OnItemClickListener listener) {
