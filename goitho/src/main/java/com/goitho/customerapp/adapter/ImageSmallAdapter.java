...
/**
 * Created by Skull on 25/01/2018.
 */

public class ImageSmallAdapter extends RecyclerView.Adapter<ImageSmallAdapter.ImageViewHolder>{

    private ArrayList<ImageEntity> list;
    private final OnItemClickListener listener;
    private Context context;

    public ImageSmallAdapter(ArrayList<ImageEntity> list, Context context, OnItemClickListener listener) {
        this.list = list;
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bind(final ImageEntity item, final OnItemClickListener listener) {
