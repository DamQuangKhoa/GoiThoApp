...
// finally change the color
    ...
    private void initFragment() {
        fragment = (DiaryFragment) getSupportFragmentManager().findFragmentById(R.id.fragmentContainer);
        if (fragment == null) {
    ...
    private void addFragmentToBackStack(DiaryFragment fragment, int frameId) {
