...
public class AddActionPresenter implements AddActionContract.Presenter{

    private final String TAG = AddActionPresenter.class.getName();
    private final AddActionContract.View view;
    ...
    @Inject
    AddActionPresenter(@NonNull AddActionContract.View view, PostActionProductUsecase postActionProductUsecase) {
        this.view = view;
