package com.goitho.customerapp.widgets.customtablayout;
...
import com.goitho.customerapp.widgets.customtablayout.utils.FragmentChangeManager;
import com.goitho.customerapp.widgets.customtablayout.utils.UnreadMsgUtils;
...
public class CustomTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextsize = ta.getDimension(R.styleable.CustomTabLayout_tl_textsize, sp2px(13f));
        mTextSelectColor = ta.getColor(R.styleable.CustomTabLayout_tl_textSelectColor, Color.parseColor("#ffffff"));
        mTextUnselectColor = ta.getColor(R.styleable.CustomTabLayout_tl_textUnselectColor, Color.parseColor("#AAffffff"));
        mTextBold = ta.getInt(R.styleable.CustomTabLayout_tl_textBold, TEXT_BOLD_NONE);
        mTextAllCaps = ta.getBoolean(R.styleable.CustomTabLayout_tl_textAllCaps, false);

        mIconVisible = ta.getBoolean(R.styleable.CustomTabLayout_tl_iconVisible, true);
        mIconGravity = ta.getInt(R.styleable.CustomTabLayout_tl_iconGravity, Gravity.TOP);
        mIconWidth = ta.getDimension(R.styleable.CustomTabLayout_tl_iconWidth, dp2px(0));
        mIconHeight = ta.getDimension(R.styleable.CustomTabLayout_tl_iconHeight, dp2px(0));
        mIconMargin = ta.getDimension(R.styleable.CustomTabLayout_tl_iconMargin, dp2px(2.5f));
