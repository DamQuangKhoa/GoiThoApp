...
public interface ProfileRepository {
    ...
    Observable<BaseResponse> activeResetPassword(int userId, String authCode, String newPassword);
    Observable<BaseResponse> activeResetPhoneNumber(int userId, String authCode, String newPhoneNumber);
